...
class _SaturnLoading extends State<SaturnLoading> with TickerProviderStateMixin{
      ...
      return SizedBox(
        ...
        child: Stack(
          children: <Widget>[
            ...
            Padding(padding: EdgeInsets.all(5),child: Transform.rotate(angle: _animation!.value,origin: Offset(35,35),child: Image.asset('repo/images/saturn.png',width: 20,height: 20,),),)
          ],
        ),
      );
    });
