...
class _SecondPage extends State<StatefulWidget> with SingleTickerProviderStateMixin{
            ...
            child: Column(
              children: <Widget>[
                AnimatedBuilder(animation: _rotateAnimation!, builder: (context,widget){
                  return Transform.translate(offset: _transAnimation!.value,
                    child: Transform.rotate(angle: _rotateAnimation!.value,
                  ...
                  child:Hero(tag: 'detail', child: Icon(Icons.ac_unit, size: 300,)),
                ),
                ElevatedButton(onPressed: (){
                  _animationController!.forward();
                }, child: Text("DO ROTATTION"))
              ],
